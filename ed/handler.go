...
import (
	...
	"github.com/Tzunami/go-earthdollar/ed/fetcher"
...
// NewProtocolManager returns a new ethereum sub protocol manager. The Earthdollar sub protocol manages peers capable
