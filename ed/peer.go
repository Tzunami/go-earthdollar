...
// PeerInfo represents a short summary of the Earthdollar sub-protocol metadata known
// about a connected peer.
type PeerInfo struct {
	Version    int      `json:"version"`    // Earthdollar protocol version negotiated
