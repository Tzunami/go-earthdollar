...
var (
	...
	maxQueuedHeaders  = 32 * 1024 // [ed/62] Maximum number of headers to queue for import (DOS protection)
...
type Downloader struct {
	...
	headerProcCh  chan []*types.Header // [ed/62] Channel to feed the header processor new tasks
