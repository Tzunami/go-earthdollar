...
func (b *rpcBackend) HasCode(contract common.Address, pending bool) (bool, error) {
	...
	res, err := b.request("ed_getCode", []interface{}{contract.Hex(), block})
	if err != nil {
		return false, err
	}
	var hex string
...
func (b *rpcBackend) ContractCall(contract common.Address, data []byte, pending bool) ([]byte, error) {
	...
	res, err := b.request("ed_call", []interface{}{args, block})
	if err != nil {
		return nil, err
	}
	var hex string
...
func (b *rpcBackend) PendingAccountNonce(account common.Address) (uint64, error) {
	res, err := b.request("ed_getTransactionCount", []interface{}{account.Hex(), "pending"})
	if err != nil {
		return 0, err
	}
	var hex string
...
func (b *rpcBackend) SuggestGasPrice() (*big.Int, error) {
	res, err := b.request("ed_gasPrice", nil)
	if err != nil {
		return nil, err
	}
	var hex string
...
func (b *rpcBackend) EstimateGasLimit(sender common.Address, contract *common.Address, value *big.Int, data []byte) (*big.Int, error) {
	...
	// Execute the RPC call and retrieve the response
	res, err := b.request("ed_estimateGas", []interface{}{args})
	if err != nil {
		return nil, err
	}
	var hex string
...
func (b *rpcBackend) SendTransaction(tx *types.Transaction) error {
	...
	res, err := b.request("ed_sendRawTransaction", []interface{}{common.ToHex(data)})
	if err != nil {
		return err
	}
	var hex string
