...
// valid Earthdollar transaction.
type TransactOpts struct {
	From   common.Address // Earthdollar account to send the transaction from
...
// Earthdollar network. It contains a collection of methods that are used by the
// higher level contract bindings to operate.
type BoundContract struct {
	address    common.Address     // Deployment address of the contract on the Earthdollar blockchain
	abi        abi.ABI            // Reflect based ABI to access the correct Earthdollar methods
...
// DeployContract deploys a contract onto the Earthdollar blockchain and binds the
