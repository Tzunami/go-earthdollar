...
// See https://github.com/Earthdollar/wiki/wiki/Web3-Secret-Storage-Definition for more information.
package accounts
...
// ImportPreSaleKey decrypts the given Earthdollar presale wallet and stores
