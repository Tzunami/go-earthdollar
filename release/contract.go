...
// DeployReleaseOracle deploys a new Earthdollar contract, binding an instance of ReleaseOracle to it.
...
// ReleaseOracle is an auto generated Go binding around an Earthdollar contract.
...
// ReleaseOracleCaller is an auto generated read-only Go binding around an Earthdollar contract.
type ReleaseOracleCaller struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// ReleaseOracleTransactor is an auto generated write-only Go binding around an Earthdollar contract.
type ReleaseOracleTransactor struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// ReleaseOracleSession is an auto generated Go binding around an Earthdollar contract,
...
// ReleaseOracleCallerSession is an auto generated read-only Go binding around an Earthdollar contract,
...
// ReleaseOracleTransactorSession is an auto generated write-only Go binding around an Earthdollar contract,
...
// ReleaseOracleRaw is an auto generated low-level Go binding around an Earthdollar contract.
type ReleaseOracleRaw struct {
	Contract *ReleaseOracle // Generic contract binding to access the raw methods on
}

// ReleaseOracleCallerRaw is an auto generated low-level read-only Go binding around an Earthdollar contract.
...
// ReleaseOracleTransactorRaw is an auto generated low-level write-only Go binding around an Earthdollar contract.
