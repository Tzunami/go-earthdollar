...
setup(
    ...
    license='GPL',
    version='0.1.23',
    url='https://github.com/Tzunami/edhash',
    download_url='https://github.com/Tzunami/edhash/tarball/v23',
    description=('Python wrappers for edhash, the earthdollar proof of work'
                 'hashing function'),
