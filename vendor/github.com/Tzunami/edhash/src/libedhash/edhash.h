...
#define EDHASH_REVISION 23
#define EDHASH_DATASET_BYTES_INIT 1073741824U // 2**30
#define EDHASH_DATASET_BYTES_GROWTH 8388608U  // 2**23
#define EDHASH_CACHE_BYTES_INIT 1073741824U // 2**24
#define EDHASH_CACHE_BYTES_GROWTH 131072U  // 2**17
#define EDHASH_EPOCH_LENGTH 30000U
#define EDHASH_MIX_BYTES 128
#define EDHASH_HASH_BYTES 64
#define EDHASH_DATASET_PARENTS 256
#define EDHASH_CACHE_ROUNDS 3
#define EDHASH_ACCESSES 64
#define EDHASH_DAG_MAGIC_NUM_SIZE 8
#define EDHASH_DAG_MAGIC_NUM 0xFEE1DEADBADDCAFE
