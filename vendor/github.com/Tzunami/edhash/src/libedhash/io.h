...
// Reference: https://github.com/Tzunami/wiki/wiki/Edhash-DAG
...
/**
 * Logs a critical error in important parts of edhash. Should mostly help
...
/**
 * Prepares io for edhash
 *
 * Create the DAG directory and the DAG file if they don't exist.
 *
 * @param[in] dirname        A null terminated c-string of the path of the edhash
 ...
 *                           https://github.com/Tzunami/wiki/wiki/Edhash-DAG
 ...
 *                           already exists
 * @return                   For possible return values @see enum edhash_io_rc
 */
 ...
 */
FILE* edhash_fopen(char const* file_name, char const* mode);
 ...
 *                         error returns NULL
 */
char* edhash_strncat(char* dest, size_t dest_size, char const* src, size_t count);
 ...
 *                       existed
 */
bool edhash_mkdir(char const* dirname);
 ...
 */
bool edhash_file_size(FILE* f, size_t* ret_size);
 ...
 */
char* edhash_io_create_filename(
	char const* dirname,
	char const* filename,
 ...
 *
 * The spec defining this directory is here: https://github.com/Tzunami/wiki/wiki/Edhash-DAG
 *
...
static inline bool edhash_io_mutable_name(
	uint32_t revision,
